...
public class BaseTests
{
    ...
    public void Base_Inbound_HandleSimple()
    {
        ...
        test.InInbound().Base().WithCallback(_ => baseExecuted = !baseExecuted);
    ...
    public void Base_Backend_HandleSimple()
    {
        ...
        test.InBackend().Base().WithCallback(_ => baseExecuted = !baseExecuted);
    ...
    public void Base_Outbound_HandleSimple()
    {
        ...
        test.InOutbound().Base().WithCallback(_ => baseExecuted = !baseExecuted);
    ...
    public void BaseOnError_HandleSimple()
    {
        ...
        test.InOnError().Base().WithCallback(_ => baseExecuted = !baseExecuted);
    ...
    public void Base_HandleSimple_WithPredicate()
    {
        ...
        test.InInbound().Base(context => context.Variables.ContainsKey("b")).WithCallback(context =>
        {
