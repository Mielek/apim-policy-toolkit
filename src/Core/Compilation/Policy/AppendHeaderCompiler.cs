...
public class AppendHeaderCompiler : IMethodPolicyHandler
{
    public string MethodName => nameof(IInboundContext.AppendHeader);
    ...
    public void Handle(ICompilationContext context, InvocationExpressionSyntax node)
    {
        ...
        var builder = new SetHeaderPolicyBuilder()
            .Name(headerName)
            .ExistsAction(SetHeaderPolicyBuilder.ExistsActionType.Append);
