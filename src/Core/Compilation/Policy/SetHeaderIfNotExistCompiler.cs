...
public class SetHeaderIfNotExistCompiler : IMethodPolicyHandler
{
    public string MethodName => nameof(IInboundContext.SetHeaderIfNotExist);
    ...
    public void Handle(ICompilationContext context, InvocationExpressionSyntax node)
    {
        ...
        var builder = new SetHeaderPolicyBuilder()
            .Name(headerName)
            .ExistsAction(SetHeaderPolicyBuilder.ExistsActionType.Skip);
